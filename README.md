...
This is the LEGO® Mindstorms EV3 **RoboDoz3r Robot** example program in the Java programming language that uses a Java Implementation of _LEGO® Mindstorms EV3 Programming Blocks (icons)_ on LeJOS EV3. 

You can find the building instructions and the LEGO® icon-based program of the _RoboDoz3r Robot_ in the LEGO® icon based (LabView-based) Programming Environment (Home Edition).
The _RoboDoz3r Robot_ is one of the Robot Remix models.
